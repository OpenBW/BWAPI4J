...
void BridgeEnum::createUpgradeTypeEnum() {
	...
	for (UpgradeType upgradeType : UpgradeTypes::allUpgradeTypes()) {
		...
		jobject whatUpgrades = globalEnv->GetStaticObjectField(unitTypeClass, globalEnv->GetStaticFieldID(unitTypeClass, upgradeType.whatUpgrades().c_str(), "Lorg/openbw/bwapi4j/type/UnitType;"));
...
void BridgeEnum::createTechTypeEnum() {
	...
	for (TechType techType : TechTypes::allTechTypes()) {
		...
		// set enum fields
		jobject race = globalEnv->GetStaticObjectField(raceClass, globalEnv->GetStaticFieldID(raceClass, techType.getRace().getName().c_str(), "Lorg/openbw/bwapi4j/type/Race;"));
		globalEnv->SetObjectField(CurrentTechType, globalEnv->GetFieldID(techTypeClass, "race", "Lorg/openbw/bwapi4j/type/Race;"), race);

		jobject weaponType = globalEnv->GetStaticObjectField(weaponTypeClass, globalEnv->GetStaticFieldID(weaponTypeClass, techType.getWeapon().getName().c_str(), "Lorg/openbw/bwapi4j/type/WeaponType;"));
		...
		jobject whatResearches = globalEnv->GetStaticObjectField(unitTypeClass, globalEnv->GetStaticFieldID(unitTypeClass, techType.whatResearches().getName().c_str(), "Lorg/openbw/bwapi4j/type/UnitType;"));
		...
		jobject order = globalEnv->GetStaticObjectField(orderClass, globalEnv->GetStaticFieldID(orderClass, techType.getOrder().getName().c_str(), "Lorg/openbw/bwapi4j/type/Order;"));
		globalEnv->SetObjectField(CurrentTechType, globalEnv->GetFieldID(techTypeClass, "order", "Lorg/openbw/bwapi4j/type/Order;"), order);

		jobject requiredUnit = globalEnv->GetStaticObjectField(unitTypeClass, globalEnv->GetStaticFieldID(unitTypeClass, techType.requiredUnit().getName().c_str(), "Lorg/openbw/bwapi4j/type/UnitType;"));
...
void BridgeEnum::createWeaponTypeEnum() {
	...
	for (WeaponType weaponType : WeaponTypes::allWeaponTypes()) {
		...
		// set enum fields
		jobject tech = globalEnv->GetStaticObjectField(techTypeClass, globalEnv->GetStaticFieldID(techTypeClass, weaponType.getTech().getName().c_str(), "Lorg/openbw/bwapi4j/type/TechType;"));
		...
		jobject whatUses = globalEnv->GetStaticObjectField(unitTypeClass, globalEnv->GetStaticFieldID(unitTypeClass, weaponType.whatUses().getName().c_str(), "Lorg/openbw/bwapi4j/type/UnitType;"));
...
void BridgeEnum::createUnitTypeEnum() {
	...
	for (UnitType unitType : UnitTypes::allUnitTypes()) {
		...
		// set enum values
		jobject race = globalEnv->GetStaticObjectField(raceClass, globalEnv->GetStaticFieldID(raceClass, unitType.getRace().getName().c_str(), "Lorg/openbw/bwapi4j/type/Race;"));
		globalEnv->SetObjectField(CurrentUnitType, globalEnv->GetFieldID(unitTypeClass, "race", "Lorg/openbw/bwapi4j/type/Race;"), race);

		jobject requiredTech = globalEnv->GetStaticObjectField(techTypeClass, globalEnv->GetStaticFieldID(techTypeClass, unitType.requiredTech().getName().c_str(), "Lorg/openbw/bwapi4j/type/TechType;"));
		...
		jobject cloakingTech = globalEnv->GetStaticObjectField(techTypeClass, globalEnv->GetStaticFieldID(techTypeClass, unitType.cloakingTech().getName().c_str(), "Lorg/openbw/bwapi4j/type/TechType;"));
		...
		jobject armorUpgrade = globalEnv->GetStaticObjectField(upgradeTypeClass, globalEnv->GetStaticFieldID(upgradeTypeClass, unitType.armorUpgrade().getName().c_str(), "Lorg/openbw/bwapi4j/type/UpgradeType;"));
		...
		jobject size = globalEnv->GetStaticObjectField(unitSizeTypeClass, globalEnv->GetStaticFieldID(unitSizeTypeClass, unitType.size().getName().c_str(), "Lorg/openbw/bwapi4j/type/UnitSizeType;"));
		...
		jobject groundWeapon = globalEnv->GetStaticObjectField(weaponTypeClass, globalEnv->GetStaticFieldID(weaponTypeClass, unitType.groundWeapon().getName().c_str(), "Lorg/openbw/bwapi4j/type/WeaponType;"));
		...
		jobject airWeapon = globalEnv->GetStaticObjectField(weaponTypeClass, globalEnv->GetStaticFieldID(weaponTypeClass, unitType.airWeapon().getName().c_str(), "Lorg/openbw/bwapi4j/type/WeaponType;"));
		...
		for(UpgradeType upgradeType : unitType.upgrades()) {
			...
			jobject upgradesMemberType = globalEnv->GetStaticObjectField(upgradeTypeClass, globalEnv->GetStaticFieldID(upgradeTypeClass, upgradeType.getName().c_str(), "Lorg/openbw/bwapi4j/type/UpgradeType;"));
		...
		for (UpgradeType upgradeType : unitType.upgradesWhat()) {
			...
			jobject upgradesWhatMemberType = globalEnv->GetStaticObjectField(upgradeTypeClass, globalEnv->GetStaticFieldID(upgradeTypeClass, upgradeType.getName().c_str(), "Lorg/openbw/bwapi4j/type/UpgradeType;"));
		...
		for (TechType techType : unitType.abilities()) {
			...
			jobject abilitiesMemberType = globalEnv->GetStaticObjectField(techTypeClass, globalEnv->GetStaticFieldID(techTypeClass, techType.getName().c_str(), "Lorg/openbw/bwapi4j/type/TechType;"));
		...
		for(TechType techType : unitType.researchesWhat()) {
			...
			jobject researchesWhatMemberType = globalEnv->GetStaticObjectField(techTypeClass, globalEnv->GetStaticFieldID(techTypeClass, techType.getName().c_str(), "Lorg/openbw/bwapi4j/type/TechType;"));
