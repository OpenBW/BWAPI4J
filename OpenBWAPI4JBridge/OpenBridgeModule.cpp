...
jmethodID onSendCallback;
jmethodID onEndCallback;
jmethodID onReceiveCallback;
...
void initializeCallbackMethods() {
	...
	onSendCallback = globalEnv->GetMethodID(jc, "onSendText", "(Ljava/lang/String;)V");
	onReceiveCallback = globalEnv->GetMethodID(jc, "onReceiveText", "(ILjava/lang/String;)V");
...
void OpenBridgeModule::onSendText(std::string text)
{
	...
	globalEnv->CallObjectMethod(globalBW, onSendCallback, string);
