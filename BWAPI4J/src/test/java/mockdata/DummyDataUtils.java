...
public final class DummyDataUtils {
  ...
  public static String compileBwapiDataSetArchiveFilename(
      final String targetDataSet, final String... versions) {
    return compileDataSetArchiveFilename("DummyBwapiData", targetDataSet, versions);
  }

  public static String compileBwemDataSetArchiveFilename(
      final String targetDataSet, final String... versions) {
    return compileDataSetArchiveFilename("DummyBwemData", targetDataSet, versions);
  }

  public static String compileDataSetArchiveFilename(
      final String prefix, final String targetDataSet, final String... versions) {
    ...
    return (prefix
        + "_"
        + targetDataSet
        + (!compiledVersions.isEmpty() ? "_" + compiledVersions : "")
        + ".tar.bz2");
  }
  ...
  private static ArchiveEntry getArchiveEntry(
      final ArchiveInputStream tarIn, final String startsWith) throws IOException {
  ...
  public static int[] readIntegerArrayFromArchiveFile(
      final String archiveFilename, final String mapHash, final String regex) throws IOException {
  ...
  public static List<List<Integer>> readMultiLineIntegerArraysFromArchiveFile(
      final String archiveFilename, final String mapHash, final String regex) throws IOException {
    final InputStream inputStream = createInputStreamForDummyDataSet(archiveFilename);
  ...
  public static List<List<String>> readMultiLinesAsStringTokensFromArchiveFile(
      final String archiveFilename, final String mapHash, final String regex) throws IOException {
    final InputStream inputStream = createInputStreamForDummyDataSet(archiveFilename);
