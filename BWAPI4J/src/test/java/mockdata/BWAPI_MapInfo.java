...
public class BWAPI_MapInfo {
    ...
    public BWAPI_MapInfo(final String mapHash, final String dataSetBwapiVersion) throws IOException {
        ...
        final List<List<String>> mapInfo = DummyDataUtils.readMultiLinesAsStringTokensFromArchiveFile(DummyDataUtils.compileBwapiDataSetArchiveFilename("MapInfo", dataSetBwapiVersion), mapHash, " ");
