...
import bwapi.UnitType.WhatBuilds;
...
public class TestDataExporter implements BWEventListener {
  ...
  private static final String TARGET_DIR = "BWAPI4J/src/test/java/mockdata/dataexporter/";
  ...
  private void addPackage(PrintWriter out) {
    out.println("package mockdata.dataexporter;");
  }
