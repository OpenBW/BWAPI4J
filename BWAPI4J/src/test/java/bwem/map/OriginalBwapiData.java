...
public class OriginalBwapiData {
    ...
    public OriginalBwapiData() throws IOException, URISyntaxException {
        ...
        populateIntegerArray("walkabilityInfo_FightingSpirit_ORIGINAL.txt", this.walkabilityInfo_ORIGINAL, " ");
        populateIntegerArray("groundInfo_FightingSpirit_ORIGINAL.txt", this.groundInfo_ORIGINAL, " ");
        populateIntegerArray("buildableInfo_FightingSpirit_ORIGINAL.txt", this.buildableInfo_ORIGINAL, " ");
    }
