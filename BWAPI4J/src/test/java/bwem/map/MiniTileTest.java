...
public class MiniTileTest implements BWEventListener {
    ...
    public void heightTest() throws AssertionError {
    	System.out.println(results4.length);
