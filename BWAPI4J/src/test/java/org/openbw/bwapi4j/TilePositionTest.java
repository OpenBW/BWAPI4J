...
public class TilePositionTest {
    ...
    public void testCasting() {
        ...
        for (int y = 0; y < 256; ++y) {
            for (int x = 0; x < 256; ++x) {
                ...
                Assert.assertEquals("TilePosition: wrong value for 'x': " + t.toString(), TILE_POSITION_X_ARR[x], t.getX());
                Assert.assertEquals("TilePosition: wrong value for 'y': " + t.toString(), TILE_POSITION_Y_ARR[y], t.getY());
    ...
    private void testAddition() {
        Assert.assertEquals("wrong result", new TilePosition(0, 0), new TilePosition(0, 0).add(new TilePosition(0, 0)));
        Assert.assertEquals("wrong result", new TilePosition(1, 1), new TilePosition(0, 0).add(new TilePosition(1, 1)));
        Assert.assertEquals("wrong result", new TilePosition(5, 5), new TilePosition(0, 0).add(new TilePosition(5, 5)));
        Assert.assertEquals("wrong result", new TilePosition(245, 157), new TilePosition(15, 48).add(new TilePosition(230, 109)));
    }

    private void testSubtraction() {
        Assert.assertEquals("wrong result", new TilePosition(0, 0), new TilePosition(0, 0).subtract(new TilePosition(0, 0)));
        Assert.assertEquals("wrong result", new TilePosition(1, 1), new TilePosition(1, 1).subtract(new TilePosition(0, 0)));
        Assert.assertEquals("wrong result", new TilePosition(5, 5), new TilePosition(5, 5).subtract(new TilePosition(0, 0)));
        Assert.assertEquals("wrong result", new TilePosition(15, 48), new TilePosition(245, 157).subtract(new TilePosition(230, 109)));
    }
