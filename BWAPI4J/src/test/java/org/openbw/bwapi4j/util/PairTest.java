...
public class PairTest {
  private void assertIntegersPair(
      final int x1,
      final int y1,
      final int x2,
      final int y2,
      final boolean displayNoCollisionDetails) {
  ...
  public void Test_Collisions_Random() {
    ...
    for (int i = 0; i < 10000; ++i) {
      ...
      while ((x1 = rng.nextInt(ceiling)) == (x2 = rng.nextInt(ceiling))
          || (y1 = rng.nextInt(ceiling)) == (y2 = rng.nextInt(ceiling))) ;
