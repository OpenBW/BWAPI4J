...
class UpgradeTypes {
  ...
  private static void initializeUpgradeType_Terran_Infantry_Armor() throws Exception {
    ...
    fields.get("whatUpgrades")
        .set(UpgradeType.Terran_Infantry_Armor, UnitType.Terran_Engineering_Bay);
    fields.get("whatsRequired").set(UpgradeType.Terran_Infantry_Armor,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Terran_Science_Facility});
    fields.get("whatUses").set(UpgradeType.Terran_Infantry_Armor, new ArrayList(Arrays
        .asList(UnitType.Terran_Firebat, UnitType.Hero_Sarah_Kerrigan, UnitType.Terran_Marine,
            UnitType.Terran_Ghost, UnitType.Terran_Civilian, UnitType.Terran_SCV,
            UnitType.Terran_Medic, UnitType.Hero_Gui_Montag, UnitType.Hero_Jim_Raynor_Marine,
  ...
  private static void initializeUpgradeType_Terran_Vehicle_Plating() throws Exception {
    ...
    fields.get("upgradeTimes").set(UpgradeType.Terran_Vehicle_Plating, new int[]{4000, 4000, 4480});
    ...
    fields.get("whatsRequired").set(UpgradeType.Terran_Vehicle_Plating,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Terran_Science_Facility});
    fields.get("whatUses").set(UpgradeType.Terran_Vehicle_Plating, new ArrayList(Arrays
        .asList(UnitType.Terran_Vulture, UnitType.Hero_Jim_Raynor_Vulture, UnitType.Terran_Goliath,
            UnitType.Terran_Siege_Tank_Tank_Mode, UnitType.Hero_Edmund_Duke_Siege_Mode,
            UnitType.Hero_Alan_Schezar, UnitType.Hero_Edmund_Duke_Tank_Mode,
  ...
  private static void initializeUpgradeType_Terran_Ship_Plating() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Terran_Ship_Plating,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Terran_Science_Facility});
    fields.get("whatUses").set(UpgradeType.Terran_Ship_Plating, new ArrayList(Arrays
        .asList(UnitType.Terran_Wraith, UnitType.Terran_Science_Vessel,
            UnitType.Hero_Arcturus_Mengsk, UnitType.Terran_Dropship, UnitType.Hero_Hyperion,
            UnitType.Terran_Battlecruiser, UnitType.Hero_Norad_II, UnitType.Hero_Tom_Kazansky,
  ...
  private static void initializeUpgradeType_Zerg_Carapace() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Zerg_Carapace,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Zerg_Lair});
    fields.get("whatUses").set(UpgradeType.Zerg_Carapace, new ArrayList(Arrays
        .asList(UnitType.Zerg_Larva, UnitType.Zerg_Egg, UnitType.Zerg_Zergling,
            UnitType.Zerg_Defiler, UnitType.Zerg_Hydralisk, UnitType.Zerg_Lurker,
            UnitType.Zerg_Ultralisk, UnitType.Hero_Torrasque, UnitType.Hero_Infested_Duran,
            UnitType.Zerg_Broodling, UnitType.Zerg_Drone, UnitType.Zerg_Infested_Terran,
            UnitType.Hero_Infested_Kerrigan, UnitType.Hero_Unclean_One, UnitType.Hero_Hunter_Killer,
            UnitType.Hero_Devouring_One, UnitType.Zerg_Cocoon, UnitType.Zerg_Lurker_Egg)));
  }
  ...
  private static void initializeUpgradeType_Zerg_Flyer_Carapace() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Zerg_Flyer_Carapace,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Zerg_Lair});
    fields.get("whatUses").set(UpgradeType.Zerg_Flyer_Carapace, new ArrayList(Arrays
        .asList(UnitType.Zerg_Overlord, UnitType.Zerg_Mutalisk, UnitType.Zerg_Guardian,
            UnitType.Zerg_Queen, UnitType.Hero_Kukulza_Mutalisk, UnitType.Zerg_Scourge,
            UnitType.Hero_Yggdrasill, UnitType.Hero_Matriarch, UnitType.Hero_Kukulza_Guardian,
  ...
  private static void initializeUpgradeType_Protoss_Ground_Armor() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Protoss_Ground_Armor,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Protoss_Templar_Archives});
    fields.get("whatUses").set(UpgradeType.Protoss_Ground_Armor, new ArrayList(Arrays
        .asList(UnitType.Protoss_Dark_Templar, UnitType.Protoss_Dark_Archon, UnitType.Protoss_Probe,
            UnitType.Protoss_Zealot, UnitType.Hero_Dark_Templar, UnitType.Protoss_Dragoon,
            UnitType.Hero_Zeratul, UnitType.Protoss_High_Templar, UnitType.Protoss_Archon,
            UnitType.Hero_Tassadar_Zeratul_Archon, UnitType.Hero_Fenix_Zealot,
            UnitType.Hero_Fenix_Dragoon, UnitType.Hero_Tassadar, UnitType.Hero_Warbringer,
            UnitType.Protoss_Reaver, UnitType.Hero_Aldaris)));
  }
  ...
  private static void initializeUpgradeType_Protoss_Air_Armor() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Protoss_Air_Armor,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Protoss_Fleet_Beacon});
    fields.get("whatUses").set(UpgradeType.Protoss_Air_Armor, new ArrayList(Arrays
        .asList(UnitType.Protoss_Observer, UnitType.Protoss_Corsair, UnitType.Protoss_Shuttle,
            UnitType.Protoss_Scout, UnitType.Protoss_Arbiter, UnitType.Hero_Mojo,
            UnitType.Protoss_Carrier, UnitType.Protoss_Interceptor, UnitType.Hero_Gantrithor,
            UnitType.Hero_Danimoth, UnitType.Hero_Artanis, UnitType.Hero_Raszagal)));
  }
  ...
  private static void initializeUpgradeType_Terran_Infantry_Weapons() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Terran_Infantry_Weapons,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Terran_Science_Facility});
    fields.get("whatUses").set(UpgradeType.Terran_Infantry_Weapons, new ArrayList(Arrays
        .asList(UnitType.Terran_Firebat, UnitType.Hero_Sarah_Kerrigan, UnitType.Terran_Marine,
            UnitType.Hero_Jim_Raynor_Marine, UnitType.Terran_Ghost, UnitType.Hero_Gui_Montag,
            UnitType.Hero_Samir_Duran, UnitType.Special_Wall_Flame_Trap,
            UnitType.Special_Right_Wall_Flame_Trap, UnitType.Hero_Alexei_Stukov,
  ...
  private static void initializeUpgradeType_Terran_Vehicle_Weapons() throws Exception {
    ...
    fields.get("upgradeTimes").set(UpgradeType.Terran_Vehicle_Weapons, new int[]{4000, 4000, 4480});
    ...
    fields.get("whatsRequired").set(UpgradeType.Terran_Vehicle_Weapons,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Terran_Science_Facility});
    fields.get("whatUses").set(UpgradeType.Terran_Vehicle_Weapons, new ArrayList(Arrays
        .asList(UnitType.Terran_Vulture, UnitType.Special_Floor_Missile_Trap,
            UnitType.Terran_Goliath, UnitType.Hero_Jim_Raynor_Vulture,
            UnitType.Hero_Edmund_Duke_Siege_Mode, UnitType.Special_Floor_Gun_Trap,
            UnitType.Hero_Alan_Schezar, UnitType.Terran_Siege_Tank_Tank_Mode,
            UnitType.Terran_Siege_Tank_Siege_Mode, UnitType.Hero_Edmund_Duke_Tank_Mode,
            UnitType.Special_Wall_Missile_Trap, UnitType.Special_Right_Wall_Missile_Trap)));
  }
  ...
  private static void initializeUpgradeType_Terran_Ship_Weapons() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Terran_Ship_Weapons,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Terran_Science_Facility});
    fields.get("whatUses").set(UpgradeType.Terran_Ship_Weapons, new ArrayList(Arrays
        .asList(UnitType.Terran_Wraith, UnitType.Hero_Norad_II, UnitType.Hero_Tom_Kazansky,
            UnitType.Hero_Hyperion, UnitType.Terran_Battlecruiser, UnitType.Hero_Arcturus_Mengsk,
  ...
  private static void initializeUpgradeType_Zerg_Melee_Attacks() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Zerg_Melee_Attacks,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Zerg_Lair});
    fields.get("whatUses").set(UpgradeType.Zerg_Melee_Attacks, new ArrayList(Arrays
        .asList(UnitType.Zerg_Zergling, UnitType.Hero_Devouring_One,
            UnitType.Hero_Infested_Kerrigan, UnitType.Zerg_Ultralisk, UnitType.Zerg_Broodling,
  ...
  private static void initializeUpgradeType_Zerg_Missile_Attacks() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Zerg_Missile_Attacks,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Zerg_Lair});
    fields.get("whatUses").set(UpgradeType.Zerg_Missile_Attacks, new ArrayList(
        Arrays.asList(UnitType.Zerg_Hydralisk, UnitType.Hero_Hunter_Killer, UnitType.Zerg_Lurker)));
  }
  ...
  private static void initializeUpgradeType_Zerg_Flyer_Attacks() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Zerg_Flyer_Attacks,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Zerg_Lair});
    fields.get("whatUses").set(UpgradeType.Zerg_Flyer_Attacks, new ArrayList(Arrays
        .asList(UnitType.Zerg_Mutalisk, UnitType.Hero_Kukulza_Mutalisk,
            UnitType.Hero_Kukulza_Guardian, UnitType.Zerg_Guardian, UnitType.Zerg_Devourer)));
  }
  ...
  private static void initializeUpgradeType_Protoss_Ground_Weapons() throws Exception {
    ...
    fields.get("upgradeTimes").set(UpgradeType.Protoss_Ground_Weapons, new int[]{4000, 4000, 4480});
    ...
    fields.get("whatsRequired").set(UpgradeType.Protoss_Ground_Weapons,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Protoss_Templar_Archives});
    fields.get("whatUses").set(UpgradeType.Protoss_Ground_Weapons, new ArrayList(Arrays
        .asList(UnitType.Protoss_Zealot, UnitType.Hero_Fenix_Zealot, UnitType.Hero_Dark_Templar,
            UnitType.Protoss_Dragoon, UnitType.Hero_Fenix_Dragoon, UnitType.Hero_Aldaris,
            UnitType.Hero_Tassadar, UnitType.Hero_Tassadar_Zeratul_Archon, UnitType.Protoss_Archon,
            UnitType.Hero_Zeratul, UnitType.Protoss_Dark_Templar)));
  }
  ...
  private static void initializeUpgradeType_Protoss_Air_Weapons() throws Exception {
    ...
    fields.get("whatsRequired").set(UpgradeType.Protoss_Air_Weapons,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Protoss_Fleet_Beacon});
    fields.get("whatUses").set(UpgradeType.Protoss_Air_Weapons, new ArrayList(Arrays
        .asList(UnitType.Hero_Danimoth, UnitType.Protoss_Scout, UnitType.Hero_Artanis,
            UnitType.Protoss_Carrier, UnitType.Hero_Mojo, UnitType.Protoss_Arbiter,
            UnitType.Protoss_Interceptor, UnitType.Protoss_Corsair)));
  }
  ...
  private static void initializeUpgradeType_Protoss_Plasma_Shields() throws Exception {
    ...
    fields.get("upgradeTimes").set(UpgradeType.Protoss_Plasma_Shields, new int[]{4000, 4000, 4480});
    ...
    fields.get("whatsRequired").set(UpgradeType.Protoss_Plasma_Shields,
        new UnitType[]{UnitType.None, UnitType.None, UnitType.Protoss_Cybernetics_Core});
    fields.get("whatUses").set(UpgradeType.Protoss_Plasma_Shields, new ArrayList(Arrays
        .asList(UnitType.Protoss_Archon, UnitType.Protoss_Corsair, UnitType.Protoss_Shuttle,
            UnitType.Protoss_Dark_Templar, UnitType.Protoss_Dark_Archon, UnitType.Protoss_Probe,
            UnitType.Protoss_Zealot, UnitType.Protoss_Dragoon, UnitType.Protoss_High_Templar,
            UnitType.Protoss_Scout, UnitType.Protoss_Arbiter, UnitType.Protoss_Carrier,
            UnitType.Protoss_Interceptor, UnitType.Hero_Dark_Templar, UnitType.Hero_Zeratul,
            UnitType.Hero_Tassadar_Zeratul_Archon, UnitType.Hero_Fenix_Zealot,
            UnitType.Hero_Fenix_Dragoon, UnitType.Hero_Tassadar, UnitType.Hero_Mojo,
            UnitType.Hero_Warbringer, UnitType.Hero_Gantrithor, UnitType.Protoss_Reaver,
            UnitType.Protoss_Observer, UnitType.Hero_Danimoth, UnitType.Hero_Aldaris,
            UnitType.Hero_Artanis, UnitType.Hero_Raszagal)));
  }
  ...
  private static void initializeUpgradeType_Titan_Reactor() throws Exception {
    ...
    fields.get("whatUses").set(UpgradeType.Titan_Reactor,
  ...
  private static void initializeUpgradeType_Colossus_Reactor() throws Exception {
    ...
    fields.get("whatUses").set(UpgradeType.Colossus_Reactor,
  ...
  private static void initializeUpgradeType_Pneumatized_Carapace() throws Exception {
    ...
    fields.get("whatsRequired")
        .set(UpgradeType.Pneumatized_Carapace, new UnitType[]{UnitType.None});
    fields.get("whatUses").set(UpgradeType.Pneumatized_Carapace,
        new ArrayList(Arrays.asList(UnitType.Zerg_Overlord)));
  }
  ...
  private static void initializeUpgradeType_Singularity_Charge() throws Exception {
    ...
    fields.get("whatUses").set(UpgradeType.Singularity_Charge,
        new ArrayList(Arrays.asList(UnitType.Protoss_Dragoon)));
  }
  ...
  private static void initializeUpgradeType_Gravitic_Boosters() throws Exception {
    ...
    fields.get("whatUses").set(UpgradeType.Gravitic_Boosters,
        new ArrayList(Arrays.asList(UnitType.Protoss_Observer)));
  }
  ...
  private static void initializeUpgradeType_Khaydarin_Amulet() throws Exception {
    ...
    fields.get("whatUses").set(UpgradeType.Khaydarin_Amulet,
  ...
  private static void initializeUpgradeType_Argus_Talisman() throws Exception {
    ...
    fields.get("whatUses").set(UpgradeType.Argus_Talisman,
