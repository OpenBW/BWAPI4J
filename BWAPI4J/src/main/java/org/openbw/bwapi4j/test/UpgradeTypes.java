...
class UpgradeTypes {
    ...
    private static void initializeUpgradeType_Terran_Infantry_Armor() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Terran_Infantry_Armor, new ArrayList(Arrays.asList(UnitType.Terran_Firebat, UnitType.Hero_Sarah_Kerrigan, UnitType.Terran_Marine, UnitType.Terran_Ghost, UnitType.Terran_Civilian, UnitType.Terran_SCV, UnitType.Terran_Medic, UnitType.Hero_Gui_Montag, UnitType.Hero_Jim_Raynor_Marine, UnitType.Hero_Samir_Duran, UnitType.Hero_Alexei_Stukov)));
    }
    private static void initializeUpgradeType_Terran_Vehicle_Plating() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Terran_Vehicle_Plating, new ArrayList(Arrays.asList(UnitType.Terran_Vulture, UnitType.Hero_Jim_Raynor_Vulture, UnitType.Terran_Goliath, UnitType.Terran_Siege_Tank_Tank_Mode, UnitType.Hero_Edmund_Duke_Siege_Mode, UnitType.Hero_Alan_Schezar, UnitType.Hero_Edmund_Duke_Tank_Mode, UnitType.Terran_Siege_Tank_Siege_Mode)));
    }
    private static void initializeUpgradeType_Terran_Ship_Plating() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Terran_Ship_Plating, new ArrayList(Arrays.asList(UnitType.Terran_Wraith, UnitType.Terran_Science_Vessel, UnitType.Hero_Arcturus_Mengsk, UnitType.Terran_Dropship, UnitType.Hero_Hyperion, UnitType.Terran_Battlecruiser, UnitType.Hero_Norad_II, UnitType.Hero_Tom_Kazansky, UnitType.Hero_Magellan, UnitType.Terran_Valkyrie, UnitType.Hero_Gerard_DuGalle)));
    }
    private static void initializeUpgradeType_Zerg_Carapace() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Zerg_Carapace, new ArrayList(Arrays.asList(UnitType.Zerg_Larva, UnitType.Zerg_Egg, UnitType.Zerg_Zergling, UnitType.Zerg_Defiler, UnitType.Zerg_Hydralisk, UnitType.Zerg_Lurker, UnitType.Zerg_Ultralisk, UnitType.Hero_Torrasque, UnitType.Hero_Infested_Duran, UnitType.Zerg_Broodling, UnitType.Zerg_Drone, UnitType.Zerg_Infested_Terran, UnitType.Hero_Infested_Kerrigan, UnitType.Hero_Unclean_One, UnitType.Hero_Hunter_Killer, UnitType.Hero_Devouring_One, UnitType.Zerg_Cocoon, UnitType.Zerg_Lurker_Egg)));
    }
    private static void initializeUpgradeType_Zerg_Flyer_Carapace() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Zerg_Flyer_Carapace, new ArrayList(Arrays.asList(UnitType.Zerg_Overlord, UnitType.Zerg_Mutalisk, UnitType.Zerg_Guardian, UnitType.Zerg_Queen, UnitType.Hero_Kukulza_Mutalisk, UnitType.Zerg_Scourge, UnitType.Hero_Yggdrasill, UnitType.Hero_Matriarch, UnitType.Hero_Kukulza_Guardian, UnitType.Zerg_Devourer)));
    }
    private static void initializeUpgradeType_Protoss_Ground_Armor() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Protoss_Ground_Armor, new ArrayList(Arrays.asList(UnitType.Protoss_Dark_Templar, UnitType.Protoss_Dark_Archon, UnitType.Protoss_Probe, UnitType.Protoss_Zealot, UnitType.Hero_Dark_Templar, UnitType.Protoss_Dragoon, UnitType.Hero_Zeratul, UnitType.Protoss_High_Templar, UnitType.Protoss_Archon, UnitType.Hero_Tassadar_Zeratul_Archon, UnitType.Hero_Fenix_Zealot, UnitType.Hero_Fenix_Dragoon, UnitType.Hero_Tassadar, UnitType.Hero_Warbringer, UnitType.Protoss_Reaver, UnitType.Hero_Aldaris)));
    }
    private static void initializeUpgradeType_Protoss_Air_Armor() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Protoss_Air_Armor, new ArrayList(Arrays.asList(UnitType.Protoss_Observer, UnitType.Protoss_Corsair, UnitType.Protoss_Shuttle, UnitType.Protoss_Scout, UnitType.Protoss_Arbiter, UnitType.Hero_Mojo, UnitType.Protoss_Carrier, UnitType.Protoss_Interceptor, UnitType.Hero_Gantrithor, UnitType.Hero_Danimoth, UnitType.Hero_Artanis, UnitType.Hero_Raszagal)));
    }
    private static void initializeUpgradeType_Terran_Infantry_Weapons() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Terran_Infantry_Weapons, new ArrayList(Arrays.asList(UnitType.Terran_Firebat, UnitType.Hero_Sarah_Kerrigan, UnitType.Terran_Marine, UnitType.Hero_Jim_Raynor_Marine, UnitType.Terran_Ghost, UnitType.Hero_Gui_Montag, UnitType.Hero_Samir_Duran, UnitType.Special_Wall_Flame_Trap, UnitType.Special_Right_Wall_Flame_Trap, UnitType.Hero_Alexei_Stukov, UnitType.Hero_Infested_Duran)));
    }
    private static void initializeUpgradeType_Terran_Vehicle_Weapons() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Terran_Vehicle_Weapons, new ArrayList(Arrays.asList(UnitType.Terran_Vulture, UnitType.Special_Floor_Missile_Trap, UnitType.Terran_Goliath, UnitType.Hero_Jim_Raynor_Vulture, UnitType.Hero_Edmund_Duke_Siege_Mode, UnitType.Special_Floor_Gun_Trap, UnitType.Hero_Alan_Schezar, UnitType.Terran_Siege_Tank_Tank_Mode, UnitType.Terran_Siege_Tank_Siege_Mode, UnitType.Hero_Edmund_Duke_Tank_Mode, UnitType.Special_Wall_Missile_Trap, UnitType.Special_Right_Wall_Missile_Trap)));
    }
    private static void initializeUpgradeType_Terran_Ship_Weapons() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Terran_Ship_Weapons, new ArrayList(Arrays.asList(UnitType.Terran_Wraith, UnitType.Hero_Norad_II, UnitType.Hero_Tom_Kazansky, UnitType.Hero_Hyperion, UnitType.Terran_Battlecruiser, UnitType.Hero_Arcturus_Mengsk, UnitType.Hero_Gerard_DuGalle, UnitType.Terran_Valkyrie)));
    }
    private static void initializeUpgradeType_Zerg_Melee_Attacks() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Zerg_Melee_Attacks, new ArrayList(Arrays.asList(UnitType.Zerg_Zergling, UnitType.Hero_Devouring_One, UnitType.Hero_Infested_Kerrigan, UnitType.Zerg_Ultralisk, UnitType.Zerg_Broodling, UnitType.Hero_Torrasque)));
    }
    private static void initializeUpgradeType_Zerg_Missile_Attacks() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Zerg_Missile_Attacks, new ArrayList(Arrays.asList(UnitType.Zerg_Hydralisk, UnitType.Hero_Hunter_Killer, UnitType.Zerg_Lurker)));
    }
    private static void initializeUpgradeType_Zerg_Flyer_Attacks() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Zerg_Flyer_Attacks, new ArrayList(Arrays.asList(UnitType.Zerg_Mutalisk, UnitType.Hero_Kukulza_Mutalisk, UnitType.Hero_Kukulza_Guardian, UnitType.Zerg_Guardian, UnitType.Zerg_Devourer)));
    }
    private static void initializeUpgradeType_Protoss_Ground_Weapons() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Protoss_Ground_Weapons, new ArrayList(Arrays.asList(UnitType.Protoss_Zealot, UnitType.Hero_Fenix_Zealot, UnitType.Hero_Dark_Templar, UnitType.Protoss_Dragoon, UnitType.Hero_Fenix_Dragoon, UnitType.Hero_Aldaris, UnitType.Hero_Tassadar, UnitType.Hero_Tassadar_Zeratul_Archon, UnitType.Protoss_Archon, UnitType.Hero_Zeratul, UnitType.Protoss_Dark_Templar)));
    }
    private static void initializeUpgradeType_Protoss_Air_Weapons() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Protoss_Air_Weapons, new ArrayList(Arrays.asList(UnitType.Hero_Danimoth, UnitType.Protoss_Scout, UnitType.Hero_Artanis, UnitType.Protoss_Carrier, UnitType.Hero_Mojo, UnitType.Protoss_Arbiter, UnitType.Protoss_Interceptor, UnitType.Protoss_Corsair)));
    }
    private static void initializeUpgradeType_Protoss_Plasma_Shields() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Protoss_Plasma_Shields, new ArrayList(Arrays.asList(UnitType.Protoss_Archon, UnitType.Protoss_Corsair, UnitType.Protoss_Shuttle, UnitType.Protoss_Dark_Templar, UnitType.Protoss_Dark_Archon, UnitType.Protoss_Probe, UnitType.Protoss_Zealot, UnitType.Protoss_Dragoon, UnitType.Protoss_High_Templar, UnitType.Protoss_Scout, UnitType.Protoss_Arbiter, UnitType.Protoss_Carrier, UnitType.Protoss_Interceptor, UnitType.Hero_Dark_Templar, UnitType.Hero_Zeratul, UnitType.Hero_Tassadar_Zeratul_Archon, UnitType.Hero_Fenix_Zealot, UnitType.Hero_Fenix_Dragoon, UnitType.Hero_Tassadar, UnitType.Hero_Mojo, UnitType.Hero_Warbringer, UnitType.Hero_Gantrithor, UnitType.Protoss_Reaver, UnitType.Protoss_Observer, UnitType.Hero_Danimoth, UnitType.Hero_Aldaris, UnitType.Hero_Artanis, UnitType.Hero_Raszagal)));
    }
    private static void initializeUpgradeType_U_238_Shells() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.U_238_Shells, new ArrayList(Arrays.asList(UnitType.Terran_Marine)));
    }
    private static void initializeUpgradeType_Ion_Thrusters() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Ion_Thrusters, new ArrayList(Arrays.asList(UnitType.Terran_Vulture)));
    }
    private static void initializeUpgradeType_Titan_Reactor() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Titan_Reactor, new ArrayList(Arrays.asList(UnitType.Terran_Science_Vessel)));
    }
    private static void initializeUpgradeType_Ocular_Implants() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Ocular_Implants, new ArrayList(Arrays.asList(UnitType.Terran_Ghost)));
    }
    private static void initializeUpgradeType_Moebius_Reactor() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Moebius_Reactor, new ArrayList(Arrays.asList(UnitType.Terran_Ghost)));
    }
    private static void initializeUpgradeType_Apollo_Reactor() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Apollo_Reactor, new ArrayList(Arrays.asList(UnitType.Terran_Wraith)));
    }
    private static void initializeUpgradeType_Colossus_Reactor() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Colossus_Reactor, new ArrayList(Arrays.asList(UnitType.Terran_Battlecruiser)));
    }
    private static void initializeUpgradeType_Ventral_Sacs() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Ventral_Sacs, new ArrayList(Arrays.asList(UnitType.Zerg_Overlord)));
    }
    private static void initializeUpgradeType_Antennae() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Antennae, new ArrayList(Arrays.asList(UnitType.Zerg_Overlord)));
    }
    private static void initializeUpgradeType_Pneumatized_Carapace() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Pneumatized_Carapace, new ArrayList(Arrays.asList(UnitType.Zerg_Overlord)));
    }
    private static void initializeUpgradeType_Metabolic_Boost() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Metabolic_Boost, new ArrayList(Arrays.asList(UnitType.Zerg_Zergling)));
    }
    private static void initializeUpgradeType_Adrenal_Glands() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Adrenal_Glands, new ArrayList(Arrays.asList(UnitType.Zerg_Zergling)));
    }
    private static void initializeUpgradeType_Muscular_Augments() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Muscular_Augments, new ArrayList(Arrays.asList(UnitType.Zerg_Hydralisk)));
    }
    private static void initializeUpgradeType_Grooved_Spines() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Grooved_Spines, new ArrayList(Arrays.asList(UnitType.Zerg_Hydralisk)));
    }
    private static void initializeUpgradeType_Gamete_Meiosis() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Gamete_Meiosis, new ArrayList(Arrays.asList(UnitType.Zerg_Queen)));
    }
    private static void initializeUpgradeType_Metasynaptic_Node() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Metasynaptic_Node, new ArrayList(Arrays.asList(UnitType.Zerg_Defiler)));
    }
    private static void initializeUpgradeType_Singularity_Charge() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Singularity_Charge, new ArrayList(Arrays.asList(UnitType.Protoss_Dragoon)));
    }
    private static void initializeUpgradeType_Leg_Enhancements() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Leg_Enhancements, new ArrayList(Arrays.asList(UnitType.Protoss_Zealot)));
    }
    private static void initializeUpgradeType_Scarab_Damage() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Scarab_Damage, new ArrayList(Arrays.asList(UnitType.Protoss_Reaver)));
    }
    private static void initializeUpgradeType_Reaver_Capacity() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Reaver_Capacity, new ArrayList(Arrays.asList(UnitType.Protoss_Reaver)));
    }
    private static void initializeUpgradeType_Gravitic_Drive() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Gravitic_Drive, new ArrayList(Arrays.asList(UnitType.Protoss_Shuttle)));
    }
    private static void initializeUpgradeType_Sensor_Array() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Sensor_Array, new ArrayList(Arrays.asList(UnitType.Protoss_Observer)));
    }
    private static void initializeUpgradeType_Gravitic_Boosters() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Gravitic_Boosters, new ArrayList(Arrays.asList(UnitType.Protoss_Observer)));
    }
    private static void initializeUpgradeType_Khaydarin_Amulet() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Khaydarin_Amulet, new ArrayList(Arrays.asList(UnitType.Protoss_High_Templar)));
    }
    private static void initializeUpgradeType_Apial_Sensors() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Apial_Sensors, new ArrayList(Arrays.asList(UnitType.Protoss_Scout)));
    }
    private static void initializeUpgradeType_Gravitic_Thrusters() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Gravitic_Thrusters, new ArrayList(Arrays.asList(UnitType.Protoss_Scout)));
    }
    private static void initializeUpgradeType_Carrier_Capacity() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Carrier_Capacity, new ArrayList(Arrays.asList(UnitType.Protoss_Carrier)));
    }
    private static void initializeUpgradeType_Khaydarin_Core() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Khaydarin_Core, new ArrayList(Arrays.asList(UnitType.Protoss_Arbiter)));
    }
    private static void initializeUpgradeType_Argus_Jewel() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Argus_Jewel, new ArrayList(Arrays.asList(UnitType.Protoss_Corsair)));
    }
    private static void initializeUpgradeType_Argus_Talisman() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Argus_Talisman, new ArrayList(Arrays.asList(UnitType.Protoss_Dark_Archon)));
    }
    private static void initializeUpgradeType_Caduceus_Reactor() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Caduceus_Reactor, new ArrayList(Arrays.asList(UnitType.Terran_Medic)));
    }
    private static void initializeUpgradeType_Chitinous_Plating() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Chitinous_Plating, new ArrayList(Arrays.asList(UnitType.Zerg_Ultralisk)));
    }
    private static void initializeUpgradeType_Anabolic_Synthesis() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Anabolic_Synthesis, new ArrayList(Arrays.asList(UnitType.Zerg_Ultralisk)));
    }
    private static void initializeUpgradeType_Charon_Boosters() throws Exception {
        ...
        fields.get("whatUses").set(UpgradeType.Charon_Boosters, new ArrayList(Arrays.asList(UnitType.Terran_Goliath)));
    }
