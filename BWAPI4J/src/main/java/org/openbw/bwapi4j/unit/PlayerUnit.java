...
public abstract class PlayerUnit extends Unit {
	...
	public int getDamageTo(PlayerUnit to) {
		...
		return 0;
		// TODO return damageEvaluator.getDamageTo(to.bwUnit.getType(), this.unitType, to.bwUnit.getPlayer(), this.bwUnit.getPlayer());
	}
	
	public int getDamageFrom(PlayerUnit from) {
		
		return 0;
		// TODO return damageEvaluator.getDamageFrom(from.bwUnit.getType(), this.unitType, from.bwUnit.getPlayer(), this.bwUnit.getPlayer());
	}
}
