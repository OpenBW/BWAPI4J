...
public class MapInitializerImpl extends MapImpl implements MapInitializer {
  ...
  public void initialize(final boolean enableTimer) {
    ...
    initializeTerrainData(
        getBWMap().mapWidth(), getBWMap().mapHeight(), getBWMap().getStartPositions());
    //    ///	bw << "Map::initialize-resize: " << timer.elapsedMilliseconds() << " ms" << endl;
    // timer.reset();
    if (enableTimer) {
    ...
    //    ///	bw << "Map::LoadData: " << timer.elapsedMilliseconds() << " ms" << endl;
    // timer.reset();
    if (enableTimer) {
    ...
    //    ///	bw << "Map::DecideSeasOrLakes: " << timer.elapsedMilliseconds() << " ms" << endl;
    // timer.reset();
    if (enableTimer) {
    ...
    //    ///	bw << "Map::InitializeNeutrals: " << timer.elapsedMilliseconds() << " ms" << endl;
    // timer.reset();
    if (enableTimer) {
    ...
    //    ///	bw << "Map::ComputeAltitude: " << timer.elapsedMilliseconds() << " ms" << endl;
    // timer.reset();
    if (enableTimer) {
    ...
    //    ///	bw << "Map::processBlockingNeutrals: " << timer.elapsedMilliseconds() << " ms" <<
    // endl; timer.reset();
    if (enableTimer) {
    ...
    //    ///	bw << "Map::computeAreas: " << timer.elapsedMilliseconds() << " ms" << endl;
    // timer.reset();
    if (enableTimer) {
    ...
    getGraph()
        .createChokePoints(
            ...
            getRawFrontier());
    //    ///	bw << "Graph::createChokePoints: " << timer.elapsedMilliseconds() << " ms" << endl;
    // timer.reset();
    if (enableTimer) {
    ...
    //    ///	bw << "Graph::computeChokePointDistanceMatrix: " << timer.elapsedMilliseconds() << "
    // ms" << endl; timer.reset();
    if (enableTimer) {
    ...
    //    ///	bw << "Graph::collectInformation: " << timer.elapsedMilliseconds() << " ms" << endl;
    // timer.reset();
    if (enableTimer) {
    ...
    //    ///	bw << "Graph::createBases: " << timer.elapsedMilliseconds() << " ms" << endl;
    // timer.reset();
    if (enableTimer) {
